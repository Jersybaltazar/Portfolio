...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    'template_t53981l',
        ...
        {
          from_name: form.name,
          to_name: "Programador Novato",
          from_email: form.email,
          to_email: "jersy.baltazar.c@gmail.com",
  ...
  return (
    ...
    >
      ...
      >
        <p className={styles.sectionSubText}>Aqui me puedes escribir</p>
        ...
        >
          ...
          <label className='flex flex-col'>
            ...
            <input
              ...
              value={form.email}
              onChange={handleChange}
              placeholder="¿Cuál es tu dirección o correo electronico?"
              className='bg-tertiary py-4 px-6 placeholder:text-secondary text-white rounded-lg outline-none border-none font-medium'
            />
          </label>
          <label className='flex flex-col'>
